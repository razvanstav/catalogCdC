...
$cases = [
    ...
    ['parent/materials', ['child' => $student, 'materials' => $materials], 'layouts/main', $parentUser, '/parent/materials'],
    ...
    ['student/attendance', ['student' => $student, 'records' => $attendance], 'layouts/main', $studentUser, '/student/attendance'],
    ...
    ['student/conversations', ['student' => $student, 'conversations' => $conversationsParent, 'activeConv' => $conversationsParent[0]], 'layouts/main', $studentUser, '/student/conversations'],
