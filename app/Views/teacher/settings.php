      ...
      <?php foreach ($allUsers as $u): ?>
        ...
        <div class="content-row">
          ...
          <div class="content-row__main">
            ...
            <div class="content-row__meta">Email / User: <strong><?= e($u['email']) ?></strong> <?= $u['phone'] ? ' • Tel: ' . e($u['phone']) : '' ?></div>
          </div>
  ...
  <div class="settings-layout">
    ...
    <section class="card settings-card">
      <form action="/teacher/settings" method="POST" class="form-stack">
        <?= csrf_field() ?>
        <div class="form-grid">
          <div class="form-group"><label class="form-label" for="first-name">Prenume</label><input type="text" id="first-name" class="form-control" value="<?= e($user['first_name'] ?? '') ?>" disabled></div>
          <div class="form-group"><label class="form-label" for="last-name">Nume</label><input type="text" id="last-name" class="form-control" value="<?= e($user['last_name'] ?? '') ?>" disabled></div>
        </div>
        <div class="form-group"><label class="form-label" for="teacher-title">Titlu sau specializare</label><input type="text" id="teacher-title" name="title" class="form-control" value="<?= e($teacher['title'] ?? 'Profesor Programare') ?>" required></div>
        <div class="form-grid">
          <div class="form-group"><label class="form-label" for="teacher-phone">Telefon</label><input type="tel" id="teacher-phone" name="phone" class="form-control" value="<?= e($teacher['phone'] ?? '') ?>"></div>
          <div class="form-group"><label class="form-label" for="teacher-email">E-mail</label><input type="email" id="teacher-email" class="form-control" value="<?= e($user['email'] ?? '') ?>" disabled></div>
        </div>
        <div class="form-group"><label class="form-label" for="teacher-bio">Despre tine și abordarea pedagogică</label><textarea id="teacher-bio" name="bio" class="form-control"><?= e($teacher['bio'] ?? '') ?></textarea></div>
        <div class="form-actions"><button type="submit" class="btn btn--primary">Salvează modificările</button></div>
      </form>
    </section>
  </div>
</section>
