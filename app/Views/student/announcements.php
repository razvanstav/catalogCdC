...
<header class="page-heading">
  <div class="page-heading__copy">
    <div class="page-kicker"><span class="badge badge--brand">Noutăți</span></div>
    <h1 class="page-title">Anunțuri pentru tine</h1>
    <p class="page-subtitle">Informările publicate pentru grupele în care ești înscris.</p>
  </div>
</header>
  ...
  <?php if (empty($announcements)): ?>
    <div class="card empty-state">
      <div>
        ...
        <p class="empty-state__text">Informările profesorului vor apărea aici.</p>
      </div>
    </div>
  <?php endif; ?>
</section>
