...
<header class="page-heading">
  <div class="page-heading__copy">
    ...
    <h1 class="page-title">Orarul meu săptămânal</h1>
    <p class="page-subtitle">Cursurile, meditațiile și atelierele la care participi.</p>
  </div>
</header>
    ...
    <article class="card schedule-day">
      ...
      <div class="schedule-list">
        ...
        <?php if (empty($daySchedules)): ?>
          <div class="empty-state"><div><p class="empty-state__text">Zi liberă</p></div></div>
        <?php endif; ?>
      </div>
    </article>
  <?php endforeach; ?>
