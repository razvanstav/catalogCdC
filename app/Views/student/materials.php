<?php $title = 'Materiale didactice'; ?>
<header class="page-heading">
  <div class="page-heading__copy">
    <div class="page-kicker"><span class="badge badge--sage">Resurse</span></div>
    <h1 class="page-title">Materiale didactice</h1>
    <p class="page-subtitle">Fișe, suporturi de teorie, linkuri și resurse pentru studiu.</p>
  </div>
</header>
  ...
  <?php foreach ($materials as $material): ?>
    ...
    <article class="card entity-card <?= e($tone) ?>">
      ...
      <div>
        ...
        <p class="entity-card__description">Resursă recomandată pentru recapitulare și aprofundare.</p>
      </div>
  ...
  <?php if (empty($materials)): ?>
    <div class="card empty-state">
      <div>
        ...
        <div class="empty-state__title">Nicio resursă publicată</div>
        <p class="empty-state__text">Materialele noi vor apărea aici.</p>
      </div>
    </div>
  <?php endif; ?>
</section>
